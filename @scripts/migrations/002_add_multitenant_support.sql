-- Multitenant Support Migration for StratixV2
-- Migration: 002_add_multitenant_support
-- Created: 2025-09-23
-- Description: Add company-based multitenancy to the OKR application
...
SELECT 'Multitenant support migration completed successfully' AS result;