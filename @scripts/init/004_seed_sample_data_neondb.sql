-- Sample Data Seeding for StratixV2 (NeonDB Version)
-- Migration: 004_seed_sample_data_neondb
-- Created: 2025-09-23
-- Description: Insert sample data for testing and demonstration (NeonDB compatible)
...
-- =============================================================================
-- SAMPLE USERS (simulating auth.users)
-- =============================================================================

-- Insert sample users in the users table
INSERT INTO public.users (id, email, encrypted_password, email_confirmed_at, raw_user_meta_data) VALUES
  ('00000000-0000-0000-0000-000000000001', 'ceo@company.com', '$2b$10$hashedpassword1', NOW(), '{"full_name": "CEO Corporativo", "role": "corporativo"}'),
  ('00000000-0000-0000-0000-000000000002', 'manager.sales@company.com', '$2b$10$hashedpassword2', NOW(), '{"full_name": "Gerente de Ventas", "role": "gerente"}'),
  ('00000000-0000-0000-0000-000000000003', 'manager.tech@company.com', '$2b$10$hashedpassword3', NOW(), '{"full_name": "Gerente de Tecnología", "role": "gerente"}'),
  ('00000000-0000-0000-0000-000000000004', 'employee1@company.com', '$2b$10$hashedpassword4', NOW(), '{"full_name": "Empleado Ventas 1", "role": "empleado"}'),
  ('00000000-0000-0000-0000-000000000005', 'employee2@company.com', '$2b$10$hashedpassword5', NOW(), '{"full_name": "Empleado Tech 1", "role": "empleado"}')
...
-- Insert sample profiles (these should be created automatically by trigger, but we'll ensure they exist)
...
SELECT 'Sample data seeding (NeonDB version) completed successfully' AS result;