-- Rollback Script for Initial Schema Migration (NeonDB Version)
-- Rollback: 001_initial_schema_neondb
-- Created: 2025-09-23
-- Description: Complete database teardown for NeonDB - removes all application objects
...
BEGIN
    ...
    RAISE NOTICE 'This is a complete database teardown operation for NeonDB';
...
-- Drop user creation trigger (for NeonDB users table)
...
SELECT 'Initial schema migration (NeonDB version) rolled back successfully - Database clean' AS result;