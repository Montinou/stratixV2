    ...
    <DashboardLayout>
      <div className="p-6 space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">Configuración de perfil de usuario</p>
        </div>
        <div className="text-center py-12">
          <p className="text-muted-foreground">Configuración de perfil en desarrollo</p>
        </div>
      </div>
    </DashboardLayout>
  )
...
export default async function ProfilePage() {
  try {
    ...
    console.error('Profile page authentication error:', error)
    redirect("/handler/sign-in")
  }
}