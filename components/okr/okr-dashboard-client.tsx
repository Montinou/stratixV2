...
interface OKRDashboardClientProps {
  stats: any;
  user: any;
}

export function OKRDashboardClient({ stats, user }: OKRDashboardClientProps) {
  return (
          ...
          <CardContent>
            <div className="space-y-4">
              <p className="text-sm text-muted-foreground">
                Usa el botón "Crear OKR" para agregar tus primeros objetivos
              </p>
            </div>
          </CardContent>
        </Card>
