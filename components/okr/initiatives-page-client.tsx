...
export function InitiativesPageClient({ initiatives, stats }: InitiativesPageClientProps) {
  ...
  return (
    <div className="space-y-6 p-6">
      <div className="flex items-center justify-between">
        ...
        <OKRCreationDialog
          buttonText="Nueva Iniciativa"
          initialTab="initiative"
        />
      </div>
      ...
      {initiatives.length > 0 ? (
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <OKRCreationDialog
              buttonText="Crear Primera Iniciativa"
              initialTab="initiative"
            />
          </CardContent>
        </Card>
