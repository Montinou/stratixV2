...
export function ObjectivesContent({ profile }: ObjectivesContentProps) {
  ...
  }, [objectives, searchTerm, statusFilter, departmentFilter, dateRange])

  const departments = useMemo(() => {
    return Array.from(new Set(objectives.map((obj) => obj.department).filter(Boolean)))
  }, [objectives])
