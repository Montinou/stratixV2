  ...
  private static templates: Record<TemplateType, TemplateConfig> = {
    objectives: {
      ...
      fields: [
        ...
        { key: 'departamento', header: 'Departamento', required: false, example: 'Ventas', description: 'Departamento responsable' },
    ...
    users: {
      ...
      fields: [
        ...
        { key: 'departamento', header: 'Departamento', required: false, example: 'Ventas', description: 'Departamento o área' },
